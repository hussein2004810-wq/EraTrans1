-- ═══════════════════════════════════════════════════════════════
--  KIUR — التهيئة الأولى لقاعدة البيانات
--  Supabase CLI: supabase db push   |   أو SQL Editor ← New query
-- ═══════════════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════════════
--  سياسات أمان الصفوف (RLS) — مفتوحة لمفتاح anon للتجربة الداخلية.
--  للإنتاج: اربط Supabase Auth وقيّد السياسات لكل دور.
-- ═══════════════════════════════════════════════════════════════
